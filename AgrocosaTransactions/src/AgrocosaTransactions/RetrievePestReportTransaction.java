 ...
 * @author Juan
 */
public class RetrievePestReportTransaction extends SIDWebTransaction {
     ...
     * @exception (none)
     */
    public RetrievePestReportTransaction() {
        super();
    ...
    public synchronized xmlNodeArray Execute() throws SQLException, Exception {
        ...
        try {
            ...
            if (this.GetNodeArray().existValue("word")) {
                word = GetNodeArray().find("word").getStringValue();
                resultArray.add("SelectedWord", word);
            }

            pstmtSelect.setString(1, "%" + word + "%");
            pstmtSelect.setString(2, "%" + word + "%");
            pstmtSelect.setString(3, "%" + word + "%");            
            pstmtSelect.setString(4, "%" + word + "%");            
            ...
            resultArray.add("Pest_Table", guardTable);
    ...
    public static void main(String[] argv) {
        try {
            RetrievePestReportTransaction transaction = new RetrievePestReportTransaction();
