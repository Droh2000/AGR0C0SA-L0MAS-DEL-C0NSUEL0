 ...
 * @author Juan
 */
public class RetrieveStockTransferOrderTransaction extends SIDWebTransaction {
     ...
     * @exception (none)
     */
    public RetrieveStockTransferOrderTransaction() {
        super();
    ...
    public synchronized boolean PrepareStatements() {
        ...
        try {
            ...
            pstmtSelect = con.prepareStatement("SELECT s.idStockTransferOrder, "
                        + "s.TransportCompany, "
                        + "s.TruckDriverName, "
                        + "s.TruckPlate, "
                        + "s.TruckBoxPlate, "
                        + "date_format(s.InsertDate,'%d/%m/%Y %h:%i %p') as InsertDate, "
                        + "COALESCE(e.Evaluate, b'0') AS Evaluate "
