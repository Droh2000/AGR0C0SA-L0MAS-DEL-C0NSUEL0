...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <!-- Search Meeting -->
        <form name="formsearch" role="form" action="taskReport.do" method="post">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <select name="taskType" id="taskType" class="form-control">
                                <option value=""></option>
                                <c:forEach items="${TaskType_HashMap}" var="item">
                                    <option value="${item.value}"  ${requestScope.SelectedTaskTypeName == item.value  ? 'selected' : ''}>${item.value}</option>
                                </c:forEach>
                            </select>                                                
                        </div>
                        <div class="form-group">
                            ...
                            <select name="status" id="status" class="form-control">
                                ...
                                <option value="En Proceso"  ${requestScope.SelectedStatus == 'En Proceso'  ? 'selected' : ''}>En Proceso</option>
                                <option value="Terminada"  ${requestScope.SelectedStatus == 'Terminada'  ? 'selected' : ''}>Terminada</option>
