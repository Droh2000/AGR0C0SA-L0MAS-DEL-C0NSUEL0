...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Reporte de Inventario por Pallets
    ...
    <section class="content">
        ...
        <!-- Search Meeting -->
        <form name="formsearch" role="form" action="inventoryDetailReport.do" method="post">
                ...
                <div class="box-body">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            <label >PalleID</label>
                            <input type="text" name="palletId" id="palletId" class="form-control" placeholder="PalletID" data-title="" value="${requestScope.SelectedPalletId}"/> 
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
