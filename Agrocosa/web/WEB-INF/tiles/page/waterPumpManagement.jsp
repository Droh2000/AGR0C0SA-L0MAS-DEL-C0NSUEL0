...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Administración de Bombas de Agua
            <small>Configuración de Bombas de Agua</small>
        </h1>
        <ol class="breadcrumb">
    ...
    <section class="content">
        ...
        <form name="paramsForm" method="POST" action="waterPumpManagement.do"  onsubmit="">
            <div class="box box-success">
                <div class="box-header with-border">
                    <h3 class="box-title">Bombas de Agua</h3>
                </div>


                <div class="box-body" id="info" > 
                    <c:forEach items="${WaterPumpInfo_Table}" var="row" varStatus="status">
                        <c:choose>
                            <c:when test="${requestScope.Method == 'Edit' and requestScope.ID == row.idWaterPump}">
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input name="Number" type="text" class="form-control pull-right" id="Number" required value="${row.Number}" />
                                            </div>                                  
                                        </div>
                                        <div class="form-group">
                                            <label>Nombre de Bomba</label>                                                
                                            <div class="input-group">
                                                <input name="WaterPumpName" type="text" class="form-control pull-right" id="WaterPumpName" required value="${row.WaterPumpName}" />
                                            </div>                                  
                                        </div>
                                        <div class="form-group">
                                            <label>Marca</label>                                                
                                        ...
                                        <div class="form-group">
                                            <label>Modelo</label>                                                
                                            <div class="input-group">  
                                                <input name="Model" type="text" class="form-control pull-right" id="Model" required value="${row.Model}" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input name="Capacity" type="text" class="form-control pull-right" id="Capacity" required value="${row.Capacity}" />
                                            </div>                                  
                                        </div>
                                        <div class="form-group">
                                            <label>Comentarios</label>                                                
                                            <div class="input-group">
                                                <textarea name="Comments" class="form-control" rows="5" id="Comments">${row.Comments}</textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label></label>                                                
                                ...
                                <input type="hidden" name="ID" title="${row.idWaterPump}" value="${row.idWaterPump}"/>
                            </c:when>
                        </c:choose>
                    </c:forEach>
                </div>
                ...
                <div class="box-footer">
                    <c:if test="${requestScope.WaterPumpInfo_Table ne null}">
                        <c:if test="${requestScope.Method ne null and requestScope.Action ne 'Done'}">&nbsp;
                            ...
                            <button type="Submit" class="btn btn-primary" title ="Cancelar" name="Method" id="btnSubmit"  onclick="location.href = 'waterPumpManagement.do'">
                            ...
                            <table id="dtable" class="table table-bordered table-striped table-hover">
                                ...
                                <tbody>
                                    <c:forEach items="${WaterPumpInfo_Table}" var="row" varStatus="status">
                                        <tr>
                                            <td>
                                                <c:if test="${requestScope.Method ne 'Edit' or (requestScope.ID == row.idWaterPump and requestScope.ID ne 'new' ) }">
                                                    <input type="checkbox" class="minimal-red" name="ID" title="${row.idWaterPump}" value="${row.idWaterPump}"
                                                           ${requestScope.ID == row.idWaterPump and requestScope.Method != 'Save' ? 'checked="checked"' : ''} onclick="radio(this);"/>
                                                </c:if>
                                            </td>
                                            <td>${row.Number}</td>
                                            <td>${row.WaterPumpName}</td>
                                            <td>${row.Brand}</td>
                                            <td>${row.Model}</td>
                                            <td>${row.Capacity}</td>
                                            <td>${row.Comments}</td>
