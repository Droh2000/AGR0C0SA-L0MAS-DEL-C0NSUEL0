...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="row">
            <form name="saveForm" id="saveForm"  method="POST" action="applicationInfo.do">
                    ...
                    <div class="box box-success">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="taskcomments" class="form-control" rows="5" id="taskcomments" readonly>${requestScope.TaskComments}</textarea>
                            </div>
                        </div><!-- /.box-body -->
                        ...
                        <div class="box-body">
                            <div class="col-xs-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input name="velocity" type="text" class="form-control pull-right" id="velocity" required value="${requestScope.SelectedVelocity}" />
                                    </div>                                  
                                </div>
                            </div>
                            <div class="col-xs-4">
                        ...
                        <div class="box-body">
                            <div class="col-xs-4">
                                <div class="form-group">
                                    ...
                                    <select name="sprinklerName" id="sprinklerName" class="form-control" data-title="Aspersora" required>
                                        <option value=""></option>
                                        <c:forEach items="${Sprinkler_HashMap}" var="item">
                                            <option value="${item.value}"  ${requestScope.SelectedSprinklerName == item.value  ? 'selected' : ''}>${item.value}</option>
                                        </c:forEach>
                                    </select> 
                                </div>                               
                            </div>                        
                    ...
                    <div class="box box-success">
                        ...
                        <div class="box-body">
                            <div class="row">
                                ...
                                <div class="col-xs-4">
                                    <div class="form-group">
                                        <label>Velocidad de Arranque</label>                                                
                                        <div class="input-group">
                                            <input name="startVelocity" type="text" class="form-control pull-right" id="startVelocity" required value="${requestScope.SelectedStartVelocity}" />
                                        </div>                                  
                                    </div>                             
                                </div>
                            </div>
        ...
        <div class="hide">
            <form name="formBack" id="formBack" action="fillApplicationInfo.do" method="post">
