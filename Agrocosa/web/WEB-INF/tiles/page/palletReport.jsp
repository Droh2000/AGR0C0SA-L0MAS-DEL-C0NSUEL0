...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Reporte de Pallets
            <small>Consulta de historial de pallets</small>
        </h1>
        <ol class="breadcrumb">
    ...
    <section class="content">
        ...
        <!-- Search Meeting -->
        <form name="formsearch" role="form" action="palletReport.do" method="post">
                ...
                <div class="box-body">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <input name="palletId" type="text" class="form-control pull-right" id="palletId" value="${requestScope.SelectedPalletId}"/>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                    ...
                    <div class="col-md-2">                        
                        <div class="form-group">
                            ...
                            <select name="process" id="process" class="form-control">                                
                                <option value=""></option>
                                <option value="NuevoPallet"  ${requestScope.SelectedProcess == 'NuevoPallet'  ? 'selected' : ''}>Nuevo Pallet</option>
                        ...
                        <div class="form-group">
                            <label >Movimiento</label>
                             <select name="movementType" id="movementType" class="form-control">                                
                                ...
                                <option value="Reversa"  ${requestScope.SelectedMovementType == 'Reversa'  ? 'selected' : ''}>Reversa</option>
                    ...
                    <table id="dtable" class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr>    
                                ...
                                <th>Color</th>
                                <th>Cantidad</th>
                                <th>Localidad Salida</th>
                                <th>Localidad Entrada</th>
                        ...
                        <tbody>
                            ...
                            <c:forEach items="${PalletInfo_Table}" var="row" varStatus="status">
                                <tr>                                 
                                    <td>${row.PalletId}</td>
                                    <td>${row.Process}</td>
                                    ...
                                    <td>${row.Color}</td>
                                    <td>${row.Quantity}</td>
                                    <td>${row.fStorageNameOut}&nbsp;&nbsp;${row.fSubstorageNameOut}</td>
                                    <td>${row.fStorageNameIn}&nbsp;&nbsp;${row.fSubstorageNameIn}</td>
                                    <td>${row.User}</td>
