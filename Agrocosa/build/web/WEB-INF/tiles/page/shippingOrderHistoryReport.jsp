...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Reporte de Historial de Embarques al Cliente
    ...
    <section class="content">
        ...
        <!-- Search Meeting -->
        <form name="formsearch" role="form" action="shippingOrderHistoryReport.do" method="post">
                ...
                <div class="box-body">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <input name="idShippingOrder" type="text" class="form-control pull-right" id="idShippingOrder" value="${requestScope.SelectedIdShippingOrder}"/>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                            <label >Pickup#</label>
                            <input name="pickupNumber" type="text" class="form-control pull-right" id="pickupNumber" value="${requestScope.SelectedPickupNumber}"/>
                        </div>                      
                    </div>
                    <div class="col-md-2">                        
                        <div class="form-group">
                            ...
                            <select name="process" id="process" class="form-control">                                
                                ...
                                <option value="Salida"  ${requestScope.SelectedProcess == 'Salida'  ? 'selected' : ''}>Salida</option>
                            </select>                                                                                    
                        </div>                        
                    </div>
                    <div class="col-md-2">                        
                        <div class="form-group">
                            ...
                            <select name="movementType" id="movementType" class="form-control">                                
                                ...
                                <option value="Embarcada"  ${requestScope.SelectedMovementType == 'Embarcada'  ? 'selected' : ''}>Embarcada</option>
                    ...
                    <div class="col-md-2">                        
                        <div class="form-group">
                            <label >Cliente</label>
                            <select name="customerName" id="customerName" class="form-control" data-title="Cliente" >
                                <option value=""></option>
                                <c:forEach items="${Customer_HashMap}" var="item">
                                    <option value="${item.value}"  ${requestScope.SelectedCustomerName == item.value  ? 'selected' : ''}>${item.value}</option>
                                </c:forEach>
                            </select> 
                        </div>                        
                    </div>
                ...
                <div class="table-responsive">
                    <table id="dtable" class="table table-bordered table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <c:forEach items="${ShippingOrderInfo_Table}" var="row" varStatus="status">
                                <tr>                                 
