...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Aspersión Foliar
            <small>Por favor seleccione un registro para capturar la aspersión foliar</small>
        </h1>
        <ol class="breadcrumb">
    ...
    <section class="content">
        ...
        <div class="box box-success">
            <div class="box-header with-border">
                <h3 class="box-title">Aspersión Foliar</h3>
                                ...
                                <tr>                                 
                                    ...
                                    <td>
                                        <form name="f${row.idTask}" id="${row.idTask}" action="" method="post">
                                            ...
                                            <button type="button" name="${row.idTask}" id="${row.idTask}" class="btn btn-primary xxs submitFormBtn" title ="Cerrar" onclick="">
        ...
        <div class="hide">
            <form name="frmFill" id="frmFill" method="post" action="aspertionInfo.do">
