...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <i class='fa fa-calendar-check-o'></i> Nuevo Riego
    ...
    <section class="content">
        ...
        <form name="saveForm" id="saveForm"  method="POST" action="newIrrigationTask.do">
            <div class="box box-success">
                ...
                <div class="box-body">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group"> 
                            <select multiple="multiple" size="10" name="duallistboxFormula" id="duallistboxFormula" class="formula" required> 
                                <c:forEach items="${AvailableFormula_Table}" var="row" varStatus="status">
                                    <option value="${row.FormulaName}">${row.FormulaName}</option> 
                                </c:forEach>
                                <c:forEach items="${SelectedFormula_Table}" var="row2" varStatus="status">
                                    <option value="${row2.FormulaName}" selected="selected">${row2.FormulaName}</option> 
                                </c:forEach>
                            </select> 
                            <script>
                                var demo2 = $('.formula').bootstrapDualListbox({
                                    nonSelectedListLabel: 'Formulas Disponibles',
                                    selectedListLabel: 'Formulas Seleccionadas',
                                    preserveSelectionOnMove: 'moved',
                                    moveOnSelect: false,
                                    infoText: false,
                                    showFilterInputs: false
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select name="irrigationType" id="irrigationType" class="form-control" data-title="Seleccione el tipo de riego" required >
                                <option value="empty"></option>
                                <c:forEach items="${IrrigationType_HashMap}" var="item">
                                    <option value="${item.value}"  ${requestScope.SelectedIrrigationTypeName == item.value  ? 'selected' : ''}>${item.value}</option>
                                </c:forEach>
                            </select>
                        </div>                                    
                        <div class="form-group">
                ...
                <div class="box-footer">
                    ...
                    <input type="hidden" name="taskType" id="taskType" value="Irrigation"/>
        ...
        <div class="hide">
            <form name="formSearch" id="formSearch" action="newIrrigationTask.do" method="post">
        ...
        <div class="modal fade" id="confirmModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <form name="formConfirm" action="newIrrigationTask.do" method="post">
                        ...
                        <div class="modal-body">
                            ...
                            <input type="hidden" name="taskType" id="taskType" value="Riego"/>
                            <input type="hidden" name="Action" id="Action" value="DeleteTask"/>
                        </div>
