...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Aplicación Foliar
            <small>Por favor seleccione un registro para capturar sus comentarios</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-caret-right"></i> Comentarios</a></li>
    ...
    <section class="content">
        ...
        <div class="box box-success">
            <div class="box-header with-border">
                <h3 class="box-title">Aplicación Foliar - Comentarios</h3>
                                    ...
                                    <td>
                                        <form name="f${row.idTask}" id="${row.idTask}" action="" method="post">
                                            ...
                                            <button type="button" name="${row.idTask}" id="${row.idTask}" class="btn btn-primary xxs confirmFormBtn" title ="Cerrar" onclick="">
                                                <i class="fa fa-comment"> Comentarios</i>
                                            </button>                                                
                                        </form>                                         
                                    </td>                                        
                                </tr>
        ...
        <div class="modal fade" id="commentsModal" role="dialog">
            <form name="editCampForm" id="guardQuizform" action="commentsApplicationInfo.do" method="post">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                ...
                                <textarea name="comments" class="form-control" rows="5"  required id="comments">${requestScope.Comments}</textarea>
                            </div>
                        </div>
                        <div class="modal-footer">
                            ...
                            <input type="hidden" name="Action" id="Action"  value="SaveTaskComments"/>
                        </div>
                    </div>
                </div>
            </form>
