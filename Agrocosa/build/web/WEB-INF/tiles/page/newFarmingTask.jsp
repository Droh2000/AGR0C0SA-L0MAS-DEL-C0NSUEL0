...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <i class='fa fa-calendar-check-o'></i> Nueva Labranza
    ...
    <section class="content">
        ...
        <form name="saveForm" id="saveForm"  method="POST" action="newFarmingTask.do">
            <div class="box box-success">
                ...
                <div class="box-body">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input name="operator" type="text" class="form-control pull-right" id="operator" value="" />
                        </div>                                                      
                        <div class="form-group">
                            <label>Tractor</label>
                            <select name="tractor" id="tractor" class="form-control" data-title="Tractor" >
                                <option value=""></option>
                        ...
                        <div class="form-group">
                            ...
                            <select name="tool" id="tool" class="form-control" data-title="Herramienta" >
                                <option value=""></option>
                ...
                <div class="box-footer">
                    ...
                    <input type="hidden" name="taskType" id="taskType" value="Farming"/>
        ...
        <div class="hide">
            <form name="formSearch" id="formSearch" action="newFarmingTask.do" method="post">
                ...
                <div class="modal-content">
                    <form name="formConfirm" action="newIrrigationTask.do" method="post">
                        ...
                        <div class="modal-body">
                            ...
                            <input type="hidden" name="taskType" id="taskType" value="Labranza"/>
                            <input type="hidden" name="Action" id="Action" value="DeleteTask"/>
                        </div>
