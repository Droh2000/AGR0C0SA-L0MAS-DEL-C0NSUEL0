...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <i class='fa fa-calendar-check-o'></i> Nueva Cosecha
    ...
    <section class="content">
        ...
        <form name="saveForm" id="saveForm"  method="POST" action="newPickingTask.do">
            <div class="box box-success">
                ...
                <div class="box-body">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <select name="Camp" id="CampName" class="form-control select2" required data-title="Seleccione el campo">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group"> 
                            <select multiple="multiple" size="10" name="duallistboxCrop" id="duallistboxCrop" class="crop" required> 
                                <c:forEach items="${CropAvailable_Table}" var="row" varStatus="status">
                                    <option value="${row.CropName}">${row.CropName}</option> 
                                </c:forEach>
                                <c:forEach items="${Crop_Table}" var="row2" varStatus="status">
                                    <option value="${row2.CropName}" selected="selected">${row2.CropName}</option> 
                                </c:forEach>
                            </select> 
                            <script>
                                var demo2 = $('.crop').bootstrapDualListbox({
                                    nonSelectedListLabel: 'Cultivos del Campo',
                                    selectedListLabel: 'Cultivos a Cosechar',
                                    preserveSelectionOnMove: 'moved',
                                    moveOnSelect: false,
                                    infoText: false,
                                    showFilterInputs: false
        ...
        <div class="hide">
            <form name="formSearch" id="formSearch" action="newPickingTask.do" method="post">
        ...
        <div class="modal fade" id="confirmModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <form name="formConfirm" action="newPickingTask.do" method="post">
                        ...
                        <div class="modal-body">
                            ...
                            <input type="hidden" name="taskType" id="taskType" value="Cosecha"/>
                            <input type="hidden" name="Action" id="Action" value="DeleteTask"/>
                        </div>
