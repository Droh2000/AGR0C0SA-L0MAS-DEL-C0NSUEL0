...
public class ScanShippingOrderMaterialServlet extends SIDServlet {

//    String customerTxn = "AgrocosaTransactions.RetrieveCustomerMaterialTransaction";
    String searchTxn = "AgrocosaTransactions.RetrieveShippingOrderDetailTransaction";
    String saveTxn = "AgrocosaTransactions.SaveScanDataTransaction";
...
//            }
            ...
            if (nodeArray != null) {
                if (nodeArray.getSize() > 0
                    ...
                    callTxnNA.find("TRANSACTION_CLASS_TO_EXECUTE").setValue(searchTxn);
            ...
            if (redirectNA != null) {
                redirectNA.add("JspPage", "/scanShippingOrderMaterial.page");
                session.setAttribute("TxData", redirectNA);
                response.sendRedirect("management.do");
            } else {
                rd = request.getRequestDispatcher("/scanShippingOrderMaterial.page");
