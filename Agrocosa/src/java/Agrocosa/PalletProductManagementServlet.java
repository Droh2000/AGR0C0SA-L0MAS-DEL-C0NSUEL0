...
public class PalletProductManagementServlet extends SIDServlet {

    String managementTxn = "AgrocosaTransactions.PalletProductManagementTransaction";
    ...
    protected void processRequest(HttpServletRequest request,
        ...
        try {
            ...
            if (txnNA != null) {
                txnNA.add("JspPage", "/palletProductManagement.page");
                session.setAttribute("TxData", txnNA);
                response.sendRedirect("management.do");
            } else {
                rd = request.getRequestDispatcher("/palletProductManagement.page");
