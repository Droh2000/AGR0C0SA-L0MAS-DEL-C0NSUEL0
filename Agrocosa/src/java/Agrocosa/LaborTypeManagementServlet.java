...
public class LaborTypeManagementServlet extends SIDServlet {

    String managementTxn = "AgrocosaTransactions.LaborTypeManagementTransaction";
    ...
    protected void processRequest(HttpServletRequest request,
        ...
        try {
            ...
            if (txnNA != null) {
                txnNA.add("JspPage", "/laborTypeManagement.page");
                session.setAttribute("TxData", txnNA);
                response.sendRedirect("management.do");
            } else {
                rd = request.getRequestDispatcher("/laborTypeManagement.page");
