...
public class RawMaterialInventoryCostReportServlet extends SIDServlet {
    ...
    String reportTxn = "AgrocosaTransactions.RetrieveRawMaterialInventoryCostReportTransaction";
    ...
    protected void processRequest(HttpServletRequest request,
        ...
        try {
            ...
            if (redirectNA != null) {
                redirectNA.add("JspPage", "/rawMaterialInventoryCostReport.page");
                session.setAttribute("TxData", redirectNA);
                response.sendRedirect("management.do");
            } else {
                rd = request.getRequestDispatcher("/rawMaterialInventoryCostReport.page");
