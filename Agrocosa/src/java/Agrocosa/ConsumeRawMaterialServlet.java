...
public class ConsumeRawMaterialServlet extends SIDServlet {
    ...
    String saveTxn = "AgrocosaTransactions.SaveConsumeRawMaterialTransaction";
    ...
    protected void processRequest(HttpServletRequest request,
        ...
        try {
            ...
            if (redirectNA != null) {
                redirectNA.add("JspPage", "/consumeRawMaterial.page");
                session.setAttribute("TxData", redirectNA);
                response.sendRedirect("management.do");
            } else {
                rd = request.getRequestDispatcher("/consumeRawMaterial.page");
