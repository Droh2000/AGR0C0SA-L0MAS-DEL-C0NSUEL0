...
public class RegionManagementServlet extends SIDServlet {

    String managementTxn = "AgrocosaTransactions.RegionManagementTransaction";
    ...
    protected void processRequest(HttpServletRequest request,
        ...
        try {
            ...
            if (txnNA != null) {
                txnNA.add("JspPage", "/regionManagement.page");
                session.setAttribute("TxData", txnNA);
                response.sendRedirect("management.do");
            } else {
                rd = request.getRequestDispatcher("/regionManagement.page");
