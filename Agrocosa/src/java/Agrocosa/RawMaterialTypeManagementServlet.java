...
public class RawMaterialTypeManagementServlet extends SIDServlet {

    String managementTxn = "AgrocosaTransactions.RawMaterialTypeManagementTransaction";
    ...
    protected void processRequest(HttpServletRequest request,
        ...
        try {
            ...
            if (txnNA != null) {
                txnNA.add("JspPage", "/rawMaterialTypeManagement.page");
                session.setAttribute("TxData", txnNA);
                response.sendRedirect("management.do");
            } else {
                rd = request.getRequestDispatcher("/rawMaterialTypeManagement.page");
