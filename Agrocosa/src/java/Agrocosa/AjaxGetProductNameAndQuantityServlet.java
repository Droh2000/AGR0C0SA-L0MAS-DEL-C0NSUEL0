...
public class AjaxGetProductNameAndQuantityServlet extends SIDServlet {

    String txn = "AgrocosaTransactions.RetrieveAjaxProductNameAndQuantityTransaction";
        ...
        try {
            ...
            if (nodeArray != null) {
                if (nodeArray.getSize() > 0
                        && nodeArray.exist("idShippingOrderDetail")
                        && !nodeArray.find("idShippingOrderDetail").isValueEmpty()) {
