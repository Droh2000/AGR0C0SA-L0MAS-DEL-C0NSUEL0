...
public class OutBinInventoryServlet extends SIDServlet {
    ...
    String saveTxn = "AgrocosaTransactions.SaveOutBinInventoryTransaction";
    ...
    protected void processRequest(HttpServletRequest request,
        ...
        try {
            ...
            if (redirectNA != null) {
                redirectNA.add("JspPage", "/outBinInventory.page");
                session.setAttribute("TxData", redirectNA);
                response.sendRedirect("management.do");
            } else {
                rd = request.getRequestDispatcher("/outBinInventory.page");
