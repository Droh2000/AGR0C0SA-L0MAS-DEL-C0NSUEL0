...
public class WaterPumpManagementServlet extends SIDServlet {

    String managementTxn = "AgrocosaTransactions.WaterPumpManagementTransaction";
    ...
    protected void processRequest(HttpServletRequest request,
        ...
        try {
            ...
            if (txnNA != null) {
                txnNA.add("JspPage", "/waterPumpManagement.page");
                session.setAttribute("TxData", txnNA);
                response.sendRedirect("management.do");
            } else {
                rd = request.getRequestDispatcher("/waterPumpManagement.page");
