...
public class NewIrrigationTaskServlet extends SIDServlet {
    ...
    String formulaTxn = "AgrocosaTransactions.RetrieveAvailableFormulaTransaction";
    String irrigationTypeTxn = "AgrocosaTransactions.IrrigationTypeMenuTransaction";    
    ...
    protected void processRequest(HttpServletRequest request,
        ...
        try {
            ...
            callTxnNA.find("TRANSACTION_CLASS_TO_EXECUTE").setValue(formulaTxn);
            txnNA = executeTransaction(callTxnNA);
            ...
            callTxnNA.find("TRANSACTION_CLASS_TO_EXECUTE").setValue(irrigationTypeTxn);
            txnNA = executeTransaction(callTxnNA);
            ...
            callTxnNA.add("taskTypeFilter", "Riego");
            txnNA = executeTransaction(callTxnNA);
            ...
            if (redirectNA != null) {
                redirectNA.add("JspPage", "/newIrrigationTask.page");
                session.setAttribute("TxData", redirectNA);
                response.sendRedirect("management.do");
            } else {
                rd = request.getRequestDispatcher("/newIrrigationTask.page");
