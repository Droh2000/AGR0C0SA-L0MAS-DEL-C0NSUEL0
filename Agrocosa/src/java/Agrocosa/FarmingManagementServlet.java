...
public class FarmingManagementServlet extends SIDServlet {

    String managementTxn = "AgrocosaTransactions.FarmingManagementTransaction";
    ...
    protected void processRequest(HttpServletRequest request,
        ...
        try {
            ...
            if (txnNA != null) {
                txnNA.add("JspPage", "/farmingManagement.page");
                session.setAttribute("TxData", txnNA);
                response.sendRedirect("management.do");
            } else {
                rd = request.getRequestDispatcher("/farmingManagement.page");
