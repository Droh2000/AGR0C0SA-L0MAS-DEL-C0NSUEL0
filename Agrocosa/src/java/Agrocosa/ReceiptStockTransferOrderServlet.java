...
public class ReceiptStockTransferOrderServlet extends SIDServlet {

    String inventoryTxn = "AgrocosaTransactions.RetrieveCrossdockInventoryTableTransaction";
    String stoTxn = "AgrocosaTransactions.RetrieveStockTransferOrderByProformaTransaction";
    String saveTxn = "AgrocosaTransactions.SaveReceiptStockTransferOrderTransaction";
        ...
        try {
            ...
            if (nodeArray != null) {
                if (nodeArray.getSize() > 0
                    ...
                    callTxnNA.find("TRANSACTION_CLASS_TO_EXECUTE").setValue(stoTxn);
            ...
            if (nodeArray != null) {
                if (nodeArray.getSize() > 0
                    ...
                    if (txnNA != null) {
                        ...
                        redirectNA.remove("Storage_Table");
                        redirectNA.remove("Inventory_Table");
            ...
            if (redirectNA != null) {
                redirectNA.add("JspPage", "/receiptStockTransferOrder.page");
                session.setAttribute("TxData", redirectNA);
                response.sendRedirect("management.do");
            } else {
                rd = request.getRequestDispatcher("/receiptStockTransferOrder.page");
