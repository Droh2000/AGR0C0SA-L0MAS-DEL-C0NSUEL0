...
public class StockTransferOrderHistoryReportServlet extends SIDServlet {

    String transportCompanyTxn = "AgrocosaTransactions.TransportCompanyMenuTransaction";
    String reportTxn = "AgrocosaTransactions.RetrieveStockTransferOrderHistoryReportTransaction";
    ...
    protected void processRequest(HttpServletRequest request,
        ...
        try {
            ...
            if (redirectNA != null) {
                redirectNA.add("JspPage", "/stockTransferOrderHistoryReport.page");
                session.setAttribute("TxData", redirectNA);
                response.sendRedirect("management.do");
            } else {
                rd = request.getRequestDispatcher("/stockTransferOrderHistoryReport.page");
