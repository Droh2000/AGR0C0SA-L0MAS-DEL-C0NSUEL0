...
public class CustomerManagementServlet extends SIDServlet {

    String managementTxn = "AgrocosaTransactions.CustomerManagementTransaction";
    ...
    protected void processRequest(HttpServletRequest request,
        ...
        try {
            ...
            if (txnNA != null) {
                txnNA.add("JspPage", "/customerManagement.page");
                session.setAttribute("TxData", txnNA);
                response.sendRedirect("management.do");
            } else {
                rd = request.getRequestDispatcher("/customerManagement.page");
