...
public class DeliveryHistoryReportServlet extends SIDServlet {

    String reportTxn = "AgrocosaTransactions.RetrieveDeliveryHistoryReportTransaction";
...
//            response.setIntHeader("Refresh", 60);
            ...
            rd = request.getRequestDispatcher("/deliveryHistoryReport.page");
