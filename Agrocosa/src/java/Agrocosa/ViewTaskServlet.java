...
public class ViewTaskServlet extends SIDServlet {
    ...
    protected void processRequest(HttpServletRequest request,
        ...
        try {
            ...
            session.setAttribute("acordion", nodeArray.find("menu").getStringValue());
            session.setAttribute("Controller", nodeArray.find("controller").getStringValue());
...
//            if (redirectNA != null) {
//                redirectNA.add("JspPage", "/viewTask.page");
//                session.setAttribute("TxData", redirectNA);
//                response.sendRedirect("management.do");
//            } else {
//                rd = request.getRequestDispatcher("/viewTask.page");
