...
public class PestsManagementServlet extends SIDServlet {

    String managementTxn = "AgrocosaTransactions.PestManagementTransaction";
    String delPicPestTxn = "AgrocosaTransactions.DeletePestPictureTransaction";
    ...
    protected void processRequest(HttpServletRequest request,
        ...
        try {
            ...
            session.setAttribute("acordion", "Pests");
            ...
            if (nodeArray != null) {
                if (nodeArray.getSize() > 0
                    ...
                    callTxnNA.find("TRANSACTION_CLASS_TO_EXECUTE").setValue(delPicPestTxn);
            ...
            if (txnNA != null) {
                txnNA.add("JspPage", "/pestsManagement.page");
                session.setAttribute("TxData", txnNA);
                response.sendRedirect("management.do");
            } else {
                rd = request.getRequestDispatcher("/pestsManagement.page");
