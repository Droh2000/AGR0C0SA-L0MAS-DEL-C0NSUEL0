...
public class AjaxRetriveDeliveryProductServlet extends SIDServlet {

    String txn = "AgrocosaTransactions.AjaxRetrieveDeliveryProductTransaction";
        ...
        try {
            ...
            if (nodeArray != null) {
                if (nodeArray.getSize() > 0
                        && nodeArray.exist("idDelivery")
                        && !nodeArray.find("idDelivery").isValueEmpty()) {
