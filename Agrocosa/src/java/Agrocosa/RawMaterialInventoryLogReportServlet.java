...
public class RawMaterialInventoryLogReportServlet extends SIDServlet {
    ...
    String reportTxn = "AgrocosaTransactions.RetrieveRawMaterialInventoryLogReportTransaction";
    ...
    protected void processRequest(HttpServletRequest request,
        ...
        try {
            ...
            if (redirectNA != null) {
                redirectNA.add("JspPage", "/rawMaterialInventoryLogReport.page");
                session.setAttribute("TxData", redirectNA);
                response.sendRedirect("management.do");
            } else {
                rd = request.getRequestDispatcher("/rawMaterialInventoryLogReport.page");
