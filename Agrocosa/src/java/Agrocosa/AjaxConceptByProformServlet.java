...
public class AjaxConceptByProformServlet extends SIDServlet {

    String txn = "AgrocosaTransactions.AjaxConceptByProformTransaction";
        ...
        try {
            ...
            if (nodeArray != null) {
                if (nodeArray.getSize() > 0
                        && nodeArray.exist("proformainput")
                        && !nodeArray.find("proformainput").isValueEmpty()) {
