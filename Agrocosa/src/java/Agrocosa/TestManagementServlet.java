...
public class TestManagementServlet extends SIDServlet {

    String managementTxn = "AgrocosaTransactions.TestManagementTransaction";
    ...
    protected void processRequest(HttpServletRequest request,
        ...
        try {
            ...
            session.setAttribute("acordion", "Section");
            ...
            if (txnNA != null) {
                txnNA.add("JspPage", "/testManagement.page");
                session.setAttribute("TxData", txnNA);
                response.sendRedirect("management.do");
            } else {
                rd = request.getRequestDispatcher("/testManagement.page");
