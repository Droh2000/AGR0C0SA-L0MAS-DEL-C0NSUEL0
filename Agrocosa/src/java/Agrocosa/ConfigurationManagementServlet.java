...
public class ConfigurationManagementServlet extends SIDServlet {

    String managementTxn = "AgrocosaTransactions.ConfigurationManagementTransaction";
    ...
    protected void processRequest(HttpServletRequest request,
        ...
        try {
            ...
            if (txnNA != null) {
                txnNA.add("JspPage", "/configurationManagement.page");
                session.setAttribute("TxData", txnNA);
                response.sendRedirect("management.do");
            } else {
                rd = request.getRequestDispatcher("/configurationManagement.page");
