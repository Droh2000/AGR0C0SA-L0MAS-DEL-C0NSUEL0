...
public class IrrigationInfoServlet extends SIDServlet {
...
//    String saveTxn = "AgrocosaTransactions.SaveTaskProductTransaction";
    String saveTxn = "AgrocosaTransactions.SaveNewTaskProductTransaction";
    ...
    protected void processRequest(HttpServletRequest request,
        ...
        try {
            ...
            session.setAttribute("acordion", "IrrigationUser");
            ...
            if (redirectNA != null) {
                redirectNA.add("JspPage", "/irrigationInfo.page");
                session.setAttribute("TxData", redirectNA);
                response.sendRedirect("management.do");
            } else {
                rd = request.getRequestDispatcher("/irrigationInfo.page");
