...
public class NewPickingTaskServlet extends SIDServlet {
    ...
    String sectionCropTxn = "AgrocosaTransactions.RetrieveAvailableSectonCropTransaction";
    ...
    protected void processRequest(HttpServletRequest request,
        ...
        try {
            ...
            //labor type
            callTxnNA.find("TRANSACTION_CLASS_TO_EXECUTE").setValue(sectionCropTxn);
            txnNA = executeTransaction(callTxnNA);
            ...
            callTxnNA.add("taskTypeFilter", "Cosecha");
            txnNA = executeTransaction(callTxnNA);
            ...
            if (redirectNA != null) {
                redirectNA.add("JspPage", "/newPickingTask.page");
                session.setAttribute("TxData", redirectNA);
                response.sendRedirect("management.do");
            } else {
                rd = request.getRequestDispatcher("/newPickingTask.page");
