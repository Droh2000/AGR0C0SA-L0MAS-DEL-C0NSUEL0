...
public class PipeTypeManagementServlet extends SIDServlet {

    String managementTxn = "AgrocosaTransactions.PipeTypeManagementTransaction";
    ...
    protected void processRequest(HttpServletRequest request,
        ...
        try {
            ...
            if (txnNA != null) {
                txnNA.add("JspPage", "/pipeTypeManagement.page");
                session.setAttribute("TxData", txnNA);
                response.sendRedirect("management.do");
            } else {
                rd = request.getRequestDispatcher("/pipeTypeManagement.page");
