...
public class ToolManagementServlet extends SIDServlet {

    String managementTxn = "AgrocosaTransactions.ToolManagementTransaction";
    ...
    protected void processRequest(HttpServletRequest request,
        ...
        try {
            ...
            if (txnNA != null) {
                txnNA.add("JspPage", "/toolManagement.page");
                session.setAttribute("TxData", txnNA);
                response.sendRedirect("management.do");
            } else {
                rd = request.getRequestDispatcher("/toolManagement.page");
