...
public class BrandManagementServlet extends SIDServlet {

    String managementTxn = "AgrocosaTransactions.BrandManagementTransaction";
    ...
    protected void processRequest(HttpServletRequest request,
        ...
        try {
            ...
            if (txnNA != null) {
                txnNA.add("JspPage", "/brandManagement.page");
                session.setAttribute("TxData", txnNA);
                response.sendRedirect("management.do");
            } else {
                rd = request.getRequestDispatcher("/brandManagement.page");
