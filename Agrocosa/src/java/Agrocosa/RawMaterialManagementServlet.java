...
public class RawMaterialManagementServlet extends SIDServlet {

    String supplierTxn = "AgrocosaTransactions.SupplierMenuTransaction";
    String brandTxn = "AgrocosaTransactions.BrandMenuTransaction";
    ...
    String managementTxn = "AgrocosaTransactions.RawMaterialManagementTransaction";
    ...
    protected void processRequest(HttpServletRequest request,
        ...
        try {
            ...
            //Supplier
            callTxnNA.add("TRANSACTION_CLASS_TO_EXECUTE", supplierTxn);
            ...
            //Brand
            callTxnNA.find("TRANSACTION_CLASS_TO_EXECUTE").setValue(brandTxn);
            txnNA = executeTransaction(callTxnNA);
            ...
            //UOM
            callTxnNA.find("TRANSACTION_CLASS_TO_EXECUTE").setValue(uomTxn);
            txnNA = executeTransaction(callTxnNA);
            ...
            if (txnNA != null) {
                redirectNA.append(txnNA);
                redirectNA.add("JspPage", "/rawMaterialManagement.page");
                session.setAttribute("TxData", redirectNA);
                response.sendRedirect("management.do");
            } else {
                rd = request.getRequestDispatcher("/rawMaterialManagement.page");
