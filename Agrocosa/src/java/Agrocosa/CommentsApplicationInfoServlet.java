...
public class CommentsApplicationInfoServlet extends SIDServlet {
    ...
    protected void processRequest(HttpServletRequest request,
        ...
        try {
            ...
            if (redirectNA != null) {
                redirectNA.add("JspPage", "/commentsApplicationInfo.page");
                session.setAttribute("TxData", redirectNA);
                response.sendRedirect("management.do");
            } else {
                rd = request.getRequestDispatcher("/commentsApplicationInfo.page");
