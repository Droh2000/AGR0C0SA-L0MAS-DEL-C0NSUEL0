...
public class DeliveryEditReportServlet extends SIDServlet {

    String reportTxn = "AgrocosaTransactions.RetrieveDeliveryEditReportTransaction";
    String modifyTxn = "AgrocosaTransactions.CloseDeliveryEditTransaction";
...
//            response.setIntHeader("Refresh", 1);
            ...
            if (nodeArray != null) {
                if (nodeArray.getSize() > 0
                        ...
                        && nodeArray.find("Action").getStringValue().equals("ModifyDelivery")) {
...
//                request = this.parseTxnResponse(request, txnNA);
//            }
            rd = request.getRequestDispatcher("/deliveryEditReport.page");
