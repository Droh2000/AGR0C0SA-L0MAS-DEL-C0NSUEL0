...
public class CampManagementServlet extends SIDServlet {
    String regionTxn = "AgrocosaTransactions.RegionMenuTransaction";
    ...
    protected void processRequest(HttpServletRequest request,
        ...
        try {
            ...
            callTxnNA.add("TRANSACTION_CLASS_TO_EXECUTE", regionTxn);
            callTxnNA.append(nodeArray);
            regionNA = executeTransaction(callTxnNA);
            ...
            if (regionNA != null) {
                regionNA.remove("RESPONSE_CODE");
                regionNA.remove("RESPONSE_MESSAGE");
                regionNA.remove("RESPONSE_DETAIL");
                txnNA.append(regionNA);
            }
            
            
            if (txnNA != null) {
                txnNA.add("JspPage", "/campManagement.page");
