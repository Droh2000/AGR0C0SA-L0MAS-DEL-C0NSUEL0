...
public class PrinterManagementServlet extends SIDServlet {

    String managementTxn = "AgrocosaTransactions.PrinterManagementTransaction";
    ...
    protected void processRequest(HttpServletRequest request,
        ...
        try {
            ...
            if (txnNA != null) {
                txnNA.add("JspPage", "/printerManagement.page");
                session.setAttribute("TxData", txnNA);
                response.sendRedirect("management.do");
            } else {
                rd = request.getRequestDispatcher("/printerManagement.page");
