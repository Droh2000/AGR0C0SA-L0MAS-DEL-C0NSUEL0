...
public class WarehouseStorageManagementServlet extends SIDServlet {
    String warehouseTypeNameTxn = "AgrocosaTransactions.RetrieveWarehouseTypeNameTransaction";
    String managementTxn = "AgrocosaTransactions.WarehouseStorageManagementTransaction";
    ...
    protected void processRequest(HttpServletRequest request,
        ...
        try {
            ...
            callTxnNA.add("TRANSACTION_CLASS_TO_EXECUTE", warehouseTypeNameTxn);
            ...
            if (txnNA != null) {
                txnNA.add("JspPage", "/warehouseStorageManagement.page");
                session.setAttribute("TxData", txnNA);
                response.sendRedirect("management.do");
            } else {
                rd = request.getRequestDispatcher("/warehouseStorageManagement.page");
