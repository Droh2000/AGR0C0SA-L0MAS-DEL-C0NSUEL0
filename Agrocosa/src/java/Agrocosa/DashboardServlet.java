...
public class DashboardServlet extends SIDServlet {

    String dashboardTxn = "AgrocosaTransactions.RetrieveDashboardReportTransaction";
    ...
    protected void processRequest(HttpServletRequest request,
        ...
        try {
            ...
            callTxnNA.add("TRANSACTION_CLASS_TO_EXECUTE", dashboardTxn);
            ...
            if (redirectNA != null) {
                redirectNA.add("JspPage", "/dashboard.page");
                session.setAttribute("TxData", redirectNA);
                response.sendRedirect("management.do");
            } else {
                rd = request.getRequestDispatcher("/dashboard.page");
