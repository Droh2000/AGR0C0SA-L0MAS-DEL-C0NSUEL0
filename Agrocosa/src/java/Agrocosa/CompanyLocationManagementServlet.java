...
public class CompanyLocationManagementServlet extends SIDServlet {

    String managementTxn = "AgrocosaTransactions.CompanyLocationManagementTransaction";
    ...
    protected void processRequest(HttpServletRequest request,
        ...
        try {
            ...
            if (txnNA != null) {
                txnNA.add("JspPage", "/companyLocationManagement.page");
                session.setAttribute("TxData", txnNA);
                response.sendRedirect("management.do");
            } else {
                rd = request.getRequestDispatcher("/companyLocationManagement.page");
