...
public class ShowUserPictureByIdServlet extends SIDServlet {
        ...
        try {
            ...
            if (nodeArray != null) {
                if (nodeArray.getSize() > 0
                    ...
                    String idUser = nodeArray.find("idUser").getStringValue();

                    con = database.GetConnection();
                    con.setAutoCommit(false);

                    String query = "Select Picture From user Where idUser = " + idUser + " ";
                    ...
                    if (empty) {
                        ...
                        String filename = sc.getRealPath("/images/user.png");
