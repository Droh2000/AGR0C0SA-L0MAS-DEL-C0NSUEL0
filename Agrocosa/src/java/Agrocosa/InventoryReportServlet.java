...
public class InventoryReportServlet extends SIDServlet {
    ...
    String reportTxn = "AgrocosaTransactions.RetrieveInventoryReportTransaction";
    ...
    protected void processRequest(HttpServletRequest request,
        ...
        try {
            ...
            if (redirectNA != null) {
                redirectNA.add("JspPage", "/inventoryReport.page");
                session.setAttribute("TxData", redirectNA);
                response.sendRedirect("management.do");
            } else {
                rd = request.getRequestDispatcher("/inventoryReport.page");
