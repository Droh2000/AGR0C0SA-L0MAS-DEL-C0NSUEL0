...
public class AjaxStockTransferOrderDetailServlet extends SIDServlet {

    String txn = "AgrocosaTransactions.RetrieveAjaxStockTransferOrderDetailTransaction";
        ...
        try {
            ...
            if (nodeArray != null) {
                if (nodeArray.getSize() > 0
                        && nodeArray.exist("idStockTransferOrder")
                        && !nodeArray.find("idStockTransferOrder").isValueEmpty()) {
