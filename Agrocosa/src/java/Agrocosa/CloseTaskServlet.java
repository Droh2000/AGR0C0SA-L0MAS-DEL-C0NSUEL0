...
public class CloseTaskServlet extends SIDServlet {

    String taskTxn = "AgrocosaTransactions.RetrieveTaskToCloseTransaction";
        ...
        try {
            ...
            if (nodeArray != null) {
                if (nodeArray.getSize() > 0
                        ...
                        && nodeArray.find("Action").getStringValue().equals("CloseTask")) {
            ...
            if (redirectNA != null) {
                redirectNA.add("JspPage", "/closeTask.page");
                session.setAttribute("TxData", redirectNA);
                response.sendRedirect("management.do");
            } else {
                rd = request.getRequestDispatcher("/closeTask.page");
