...
public class ConsumeRawMaterialComposedServlet extends SIDServlet {
    String bomTxn = "AgrocosaTransactions.BomMenuTransaction";
    String saveTxn = "AgrocosaTransactions.SaveConsumeRawMaterialComposedTransaction";
    ...
    protected void processRequest(HttpServletRequest request,
        ...
        try {
            ...
            callTxnNA.add("TRANSACTION_CLASS_TO_EXECUTE", bomTxn);
            ...
            if (redirectNA != null) {
                redirectNA.add("JspPage", "/consumeRawMaterialComposed.page");
                session.setAttribute("TxData", redirectNA);
                response.sendRedirect("management.do");
            } else {
                rd = request.getRequestDispatcher("/consumeRawMaterialComposed.page");
