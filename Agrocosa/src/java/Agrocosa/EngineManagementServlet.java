...
public class EngineManagementServlet extends SIDServlet {

    String managementTxn = "AgrocosaTransactions.EngineManagementTransaction";
    ...
    protected void processRequest(HttpServletRequest request,
        ...
        try {
            ...
            if (txnNA != null) {
                txnNA.add("JspPage", "/engineManagement.page");
                session.setAttribute("TxData", txnNA);
                response.sendRedirect("management.do");
            } else {
                rd = request.getRequestDispatcher("/engineManagement.page");
