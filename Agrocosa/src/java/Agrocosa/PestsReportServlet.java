...
public class PestsReportServlet extends SIDServlet {

    String reportTxn = "AgrocosaTransactions.RetrievePestReportTransaction";
    ...
    protected void processRequest(HttpServletRequest request,
        ...
        try {
            ...
            if (redirectNA != null) {
                redirectNA.add("JspPage", "/pestReport.page");
                session.setAttribute("TxData", redirectNA);
                response.sendRedirect("management.do");
            } else {
                rd = request.getRequestDispatcher("/pestReport.page");
