...
public class StockTransferAssignRampReportServlet extends SIDServlet {

    String retrieveTransfersAssignRamp = "AgrocosaTransactions.StockTransferAssignRampReportTransaction";
    ...
    protected void processRequest(HttpServletRequest request,
        ...
        try {
            ...
            callTxnNA.add("TRANSACTION_CLASS_TO_EXECUTE", retrieveTransfersAssignRamp);
            ...
            if (redirectNA != null) {
                redirectNA.add("JspPage", "/stockTransferAssignRampReport.page");
                
                session.setAttribute("TxData", redirectNA);
                response.sendRedirect("management.do");
            } else {
                rd = request.getRequestDispatcher("/stockTransferAssignRampReport.page");
