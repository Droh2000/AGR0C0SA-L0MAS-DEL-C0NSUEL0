 ...
 * @author Sly
 */
public class AjaxDeleteBomDetailServlet extends SIDServlet {

    String txn = "AgrocosaTransactions.DeleteIdBomDetailTransaction";
        ...
        try {
            ...
            if (nodeArray != null) {
                if (nodeArray.getSize() > 0
                        && nodeArray.exist("idBomDetail")
                        && !nodeArray.find("idBomDetail").isValueEmpty()) {
