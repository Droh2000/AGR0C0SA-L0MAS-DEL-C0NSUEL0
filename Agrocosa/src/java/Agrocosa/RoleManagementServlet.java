...
public class RoleManagementServlet extends SIDServlet {

    String managementTxn = "AgrocosaTransactions.RoleManagementTransaction";
    ...
    protected void processRequest(HttpServletRequest request,
        ...
        try {
            ...
            if (txnNA != null) {
                txnNA.add("JspPage", "/roleManagement.page");
                session.setAttribute("TxData", txnNA);
                response.sendRedirect("management.do");
            } else {
                rd = request.getRequestDispatcher("/roleManagement.page");
