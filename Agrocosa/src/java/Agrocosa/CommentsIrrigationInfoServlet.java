...
public class CommentsIrrigationInfoServlet extends SIDServlet {

    String taskTxn = "AgrocosaTransactions.RetrieveTaskInProcessTransaction";
    String saveCommentsTxn = "AgrocosaTransactions.SaveTaskCommentTransaction";
    ...
    protected void processRequest(HttpServletRequest request,
        ...
        try {
            ...
            session.setAttribute("acordion", "Comments");
            ...
            if (nodeArray != null) {
                if (nodeArray.getSize() > 0
                        ...
                        && nodeArray.find("Action").getStringValue().equals("SaveTaskComments")) {
                    callTxnNA.find("TRANSACTION_CLASS_TO_EXECUTE").setValue(saveCommentsTxn);
            ...
            if (redirectNA != null) {
                redirectNA.add("JspPage", "/commentsIrrigationInfo.page");
                session.setAttribute("TxData", redirectNA);
                response.sendRedirect("management.do");
            } else {
                rd = request.getRequestDispatcher("/commentsIrrigationInfo.page");
