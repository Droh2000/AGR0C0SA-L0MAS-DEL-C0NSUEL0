...
public class StorageManagementServlet extends SIDServlet {

    String managementTxn = "AgrocosaTransactions.StorageManagementTransaction";
    ...
    protected void processRequest(HttpServletRequest request,
        ...
        try {
            ...
            if (txnNA != null) {
                txnNA.add("JspPage", "/storageManagement.page");
                session.setAttribute("TxData", txnNA);
                response.sendRedirect("management.do");
            } else {
                rd = request.getRequestDispatcher("/storageManagement.page");
