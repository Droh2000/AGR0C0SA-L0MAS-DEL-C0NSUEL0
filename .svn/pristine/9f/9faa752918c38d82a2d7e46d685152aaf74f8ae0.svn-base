...
public class ReceiptPickingServlet extends SIDServlet {
    ...
    String reportTxn = "AgrocosaTransactions.RetrievePickingToReceiptTransaction";
    ...
    protected void processRequest(HttpServletRequest request,
        ...
        try {
            ...
            session.setAttribute("acordion", "Drying");
            ...
            if (redirectNA != null) {
                redirectNA.add("JspPage", "/receiptPicking.page");
                session.setAttribute("TxData", redirectNA);
                response.sendRedirect("management.do");
            } else {
                rd = request.getRequestDispatcher("/receiptPicking.page");
