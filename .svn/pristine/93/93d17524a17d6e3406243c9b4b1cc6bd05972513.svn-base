...
public class SprinklerManagementServlet extends SIDServlet {

    String managementTxn = "AgrocosaTransactions.SprinklerManagementTransaction";
    ...
    protected void processRequest(HttpServletRequest request,
        ...
        try {
            ...
            if (txnNA != null) {
                txnNA.add("JspPage", "/sprinklerManagement.page");
                session.setAttribute("TxData", txnNA);
                response.sendRedirect("management.do");
            } else {
                rd = request.getRequestDispatcher("/sprinklerManagement.page");
