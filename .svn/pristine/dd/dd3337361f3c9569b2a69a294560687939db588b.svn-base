...
public class TaskHistoryReportServlet extends SIDServlet {

    String reportTxn = "AgrocosaTransactions.RetrieveTaskHistoryReportTransaction";
    ...
    protected void processRequest(HttpServletRequest request,
        ...
        try {
            ...
            if (redirectNA != null) {
                redirectNA.add("JspPage", "/taskHistoryReport.page");
                session.setAttribute("TxData", redirectNA);
                response.sendRedirect("management.do");
            } else {
                rd = request.getRequestDispatcher("/taskHistoryReport.page");
