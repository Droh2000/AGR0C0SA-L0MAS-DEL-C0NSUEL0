...
public class UomConversionManagementServlet extends SIDServlet {

    String uomTxn = "AgrocosaTransactions.UOMMenuTransaction";
    String managementTxn = "AgrocosaTransactions.UomConversionManagementTransaction";
    ...
    protected void processRequest(HttpServletRequest request,
        ...
        try {
            ...
            if (txnNA != null) {
                redirectNA.append(txnNA);
                redirectNA.add("JspPage", "/uomConversionManagement.page");
                session.setAttribute("TxData", redirectNA);
                response.sendRedirect("management.do");
            } else {
                rd = request.getRequestDispatcher("/uomConversionManagement.page");
