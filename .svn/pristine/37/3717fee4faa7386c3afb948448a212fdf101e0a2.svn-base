...
public class InventoryDetailReportServlet extends SIDServlet {
    ...
    String reportTxn = "AgrocosaTransactions.RetrieveInventoryDetailReportTransaction";
    ...
    protected void processRequest(HttpServletRequest request,
        ...
        try {
            ...
            callTxnNA.add("TRANSACTION_CLASS_TO_EXECUTE", palletProductTxn);
            ...
            if (redirectNA != null) {
                redirectNA.add("JspPage", "/inventoryDetailReport.page");
                session.setAttribute("TxData", redirectNA);
                response.sendRedirect("management.do");
            } else {
                rd = request.getRequestDispatcher("/inventoryDetailReport.page");
