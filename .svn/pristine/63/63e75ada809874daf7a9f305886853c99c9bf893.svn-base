 ...
 * @author Sly
 */
public class AjaxDeleteSectionCropServlet extends SIDServlet {

    String txn = "AgrocosaTransactions.DeleteIdSectionCropTransaction";
        ...
        try {
            ...
            if (nodeArray != null) {
                if (nodeArray.getSize() > 0
                        && nodeArray.exist("idSectionCrop")
                        && !nodeArray.find("idSectionCrop").isValueEmpty()) {
