...
public class TaskJournalReportServlet extends SIDServlet {

    String campTxn = "AgrocosaTransactions.CampMenuTransaction";
    String laborTypeTxn = "AgrocosaTransactions.LaborTypeMenuTransaction";
    String reportTxn = "AgrocosaTransactions.RetrieveTaskJournalReportTransaction";
    ...
    protected void processRequest(HttpServletRequest request,
        ...
        try {
            ...
            if (redirectNA != null) {
                redirectNA.add("JspPage", "/taskJournalReport.page");
                session.setAttribute("TxData", redirectNA);
                response.sendRedirect("management.do");
            } else {
                rd = request.getRequestDispatcher("/taskJournalReport.page");
