...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Reporte de Formulas
            <small>Consulta de formulas por campo / sección</small>
        </h1>
        <ol class="breadcrumb">
    ...
    <section class="content">
        ...
        <!-- Search Meeting -->
        <form name="formsearch" role="form" action="taskFormulaReport.do" method="post">
                ...
                <div class="box-body">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            <label >Formula</label>
                            <select name="formulaName" id="formulaName" class="form-control">
                                <option value=""></option>
                                <c:forEach items="${Formula_HashMap}" var="item">
                                    <option value="${item.value}"  ${requestScope.SelectedFormulaName == item.value  ? 'selected' : ''}>${item.value}</option>
                                </c:forEach>
                            </select>                                                
                        </div>
                    </div>
