...
public class TaskAgrochemicalReportServlet extends SIDServlet {

    String formulaTxn = "AgrocosaTransactions.AgrochemicalMenuTransaction";
    String campTxn = "AgrocosaTransactions.CampMenuTransaction";
    String reportTxn = "AgrocosaTransactions.RetrieveTaskAgrochemicalReportTransaction";
    ...
    protected void processRequest(HttpServletRequest request,
        ...
        try {
            ...
            callTxnNA.add("TRANSACTION_CLASS_TO_EXECUTE", formulaTxn);
            ...
            if (redirectNA != null) {
                redirectNA.add("JspPage", "/taskAgrochemicalReport.page");
                session.setAttribute("TxData", redirectNA);
                response.sendRedirect("management.do");
            } else {
                rd = request.getRequestDispatcher("/taskAgrochemicalReport.page");
