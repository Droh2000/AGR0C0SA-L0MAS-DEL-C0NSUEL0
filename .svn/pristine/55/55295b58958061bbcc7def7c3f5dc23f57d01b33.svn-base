...
public class CommentsFarmingInfoServlet extends SIDServlet {
    ...
    protected void processRequest(HttpServletRequest request,
        ...
        try {
            ...
            callTxnNA.add("taskType", "Labranza");
            callTxnNA.append(nodeArray);
            txnNA = executeTransaction(callTxnNA);
            ...
            if (redirectNA != null) {
                redirectNA.add("JspPage", "/commentsFarmingInfo.page");
                session.setAttribute("TxData", redirectNA);
                response.sendRedirect("management.do");
            } else {
                rd = request.getRequestDispatcher("/commentsFarmingInfo.page");
