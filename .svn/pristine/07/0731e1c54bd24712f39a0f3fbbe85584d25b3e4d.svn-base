...
public class BinHistoryReportServlet extends SIDServlet {
    ...
    String reportTxn = "AgrocosaTransactions.RetrieveBinHistoryReportTransaction";
    ...
    protected void processRequest(HttpServletRequest request,
        ...
        try {
            ...
            if (redirectNA != null) {
                redirectNA.add("JspPage", "/binHistoryReport.page");
                session.setAttribute("TxData", redirectNA);
                response.sendRedirect("management.do");
            } else {
                rd = request.getRequestDispatcher("/binHistoryReport.page");
