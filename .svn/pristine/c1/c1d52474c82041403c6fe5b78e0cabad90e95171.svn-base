...
public class RawMaterialInventoryReportServlet extends SIDServlet {
    ...
    String reportTxn = "AgrocosaTransactions.RetrieveRawMaterialInventoryReportTransaction";
    ...
    protected void processRequest(HttpServletRequest request,
        ...
        try {
            ...
            if (redirectNA != null) {
                redirectNA.add("JspPage", "/rawMaterialInventoryReport.page");
                session.setAttribute("TxData", redirectNA);
                response.sendRedirect("management.do");
            } else {
                rd = request.getRequestDispatcher("/rawMaterialInventoryReport.page");
