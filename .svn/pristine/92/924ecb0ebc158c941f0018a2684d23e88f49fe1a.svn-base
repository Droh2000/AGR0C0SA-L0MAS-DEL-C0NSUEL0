...
public class WarehouseReportServlet extends SIDServlet {

    String reportTxn = "AgrocosaTransactions.RetrieveWarehouseReportTransaction";
    ...
    protected void processRequest(HttpServletRequest request,
        ...
        try {
            ...
            rd = request.getRequestDispatcher("/warehouseReport.page");
