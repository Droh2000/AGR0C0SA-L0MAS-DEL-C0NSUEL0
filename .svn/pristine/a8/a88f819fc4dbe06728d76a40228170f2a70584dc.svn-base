...
public class ApplicationInfoServlet extends SIDServlet {

    String taskTxn = "AgrocosaTransactions.RetrieveTaskInfoTransaction";
    String uomTxn = "AgrocosaTransactions.UOMMenuTransaction";
//    String saveTxn = "AgrocosaTransactions.SaveTaskProductTransaction";
//    String saveTxn = "AgrocosaTransactions.SaveTaskProductAndAspertionTransaction";
    String saveTxn = "AgrocosaTransactions.SaveNewTaskProductAndAspertionTransaction";
    String tractorTxn = "AgrocosaTransactions.TractorMenuTransaction";
    String toolTxn = "AgrocosaTransactions.ToolMenuTransaction";
    String sprinklerTxn = "AgrocosaTransactions.SprinklerMenuTransaction";
    ...
    protected void processRequest(HttpServletRequest request,
        ...
        try {
            ...
            session.setAttribute("Controller", "fillApplicationInfo.do");
            ...
            callTxnNA.find("TRANSACTION_CLASS_TO_EXECUTE").setValue(sprinklerTxn);
            txnNA = executeTransaction(callTxnNA);
            if (txnNA != null) {
                txnNA.remove("RESPONSE_CODE");
                txnNA.remove("RESPONSE_MESSAGE");
            ...
            if (redirectNA != null) {
                redirectNA.add("JspPage", "/applicationInfo.page");
                session.setAttribute("TxData", redirectNA);
                response.sendRedirect("management.do");
            } else {
                rd = request.getRequestDispatcher("/applicationInfo.page");
