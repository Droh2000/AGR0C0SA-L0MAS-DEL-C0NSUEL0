...
public class PalletReportServlet extends SIDServlet {

    String palletProductTxn = "AgrocosaTransactions.PalletProductMenuTransaction";
    String reportTxn = "AgrocosaTransactions.RetrievePalletReportTransaction";
    ...
    protected void processRequest(HttpServletRequest request,
        ...
        try {
            ...
            if (redirectNA != null) {
                redirectNA.add("JspPage", "/palletReport.page");
                session.setAttribute("TxData", redirectNA);
                response.sendRedirect("management.do");
            } else {
                rd = request.getRequestDispatcher("/palletReport.page");
