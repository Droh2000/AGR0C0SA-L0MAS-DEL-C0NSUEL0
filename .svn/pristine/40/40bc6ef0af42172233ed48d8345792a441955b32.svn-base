...
public class ConsolidatePalletsServlet extends SIDServlet {

    String inventoryTxn = "AgrocosaTransactions.RetrieveCrossdockPalletsTableTransaction";
    String saveTxn = "AgrocosaTransactions.SaveConsolidatePalletsTransaction";
    ...
    protected void processRequest(HttpServletRequest request,
        ...
        try {
            ...
            session.setAttribute("acordion", "Pallets");
            ...
            if (redirectNA != null) {
                redirectNA.add("JspPage", "/consolidatedPallets.page");
                session.setAttribute("TxData", redirectNA);
                response.sendRedirect("management.do");
            } else {
                rd = request.getRequestDispatcher("/consolidatedPallets.page");
