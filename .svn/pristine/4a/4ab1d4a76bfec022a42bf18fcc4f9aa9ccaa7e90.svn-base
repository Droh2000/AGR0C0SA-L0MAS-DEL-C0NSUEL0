...
public class CampConfigurationServlet extends SIDServlet {

    String campTxn = "AgrocosaTransactions.RetrieveCampTransaction";
    String campMenuTxn = "AgrocosaTransactions.CampMenuTransaction";
    ...
    protected void processRequest(HttpServletRequest request,
        ...
        try {
            ...
            callTxnNA.add("TRANSACTION_CLASS_TO_EXECUTE", campMenuTxn);
            ...
            if (nodeArray != null) {
                if (nodeArray.getSize() > 0
                        ...
                        && nodeArray.find("Action").getStringValue().equals("SearchCamp")) {
            ...
            if (redirectNA != null) {
                redirectNA.add("JspPage", "/campConfiguration.page");
                session.setAttribute("TxData", redirectNA);
                response.sendRedirect("management.do");
            } else {
                rd = request.getRequestDispatcher("/campConfiguration.page");
