...
public class DeliveryReportServlet extends SIDServlet {

    String reportTxn = "AgrocosaTransactions.RetrieveDeliveryReportTransaction";
    String closeTxn = "AgrocosaTransactions.CloseDeliveryTransaction";
...
//            response.setIntHeader("Refresh", 1);
            ...
            if (nodeArray != null) {
                if (nodeArray.getSize() > 0
                        ...
                        && nodeArray.find("Action").getStringValue().equals("CloseDelivery")) {
            ...
            rd = request.getRequestDispatcher("/deliveryReport.page");
