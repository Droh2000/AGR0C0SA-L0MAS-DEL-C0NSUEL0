...
public class FormulaManagementServlet extends SIDServlet {

    String managementTxn = "AgrocosaTransactions.FormulaManagementTransaction";
    ...
    protected void processRequest(HttpServletRequest request,
        ...
        try {
            ...
            if (txnNA != null) {
                txnNA.add("JspPage", "/formulaManagement.page");
                session.setAttribute("TxData", txnNA);
                response.sendRedirect("management.do");
            } else {
                rd = request.getRequestDispatcher("/formulaManagement.page");
