...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <form name="saveForm" id="saveForm"  method="POST" action="newApplicationTask.do">
            <div class="box box-success">
                ...
                <div class="box-footer">
                    ...
                    <input type="hidden" name="taskType" id="taskType" value="Application"/>
        ...
        <div class="hide">
            <form name="formSearch" id="formSearch" action="newApplicationTask.do" method="post">
        ...
        <div class="modal fade" id="confirmModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <form name="formConfirm" action="newApplicationTask.do" method="post">
                        ...
                        <div class="modal-body">
                            ...
                            <input type="hidden" name="taskType" id="taskType" value="Aplicacion"/>
                            <input type="hidden" name="Action" id="Action" value="DeleteTask"/>
                        </div>
