...
public class ShippingHistoryReportServlet extends SIDServlet {

    String reportTxn = "AgrocosaTransactions.RetrieveShippingHistoryReportTransaction";
...
//            response.setIntHeader("Refresh", 60);
            ...
            rd = request.getRequestDispatcher("/shippingHistoryReport.page");
