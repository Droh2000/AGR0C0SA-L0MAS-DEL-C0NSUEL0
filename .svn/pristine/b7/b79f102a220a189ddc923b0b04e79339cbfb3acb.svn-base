...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Reporte de Inventario de Bines
            <small>Consulta de inventario por localidades y cultivos</small>
        </h1>
        <ol class="breadcrumb">
    ...
    <section class="content">
        ...
        <!-- Search Meeting -->
        <form name="formsearch" role="form" action="binInventoryReport.do" method="post">
        ...
        <div class="box box-success">
            <div class="box-header with-border">
                <h3 class="box-title">Inventario de Bines</h3>
            ...
            <div class="box-body">
                <div class="table-responsive">
                    <table id="dtable" class="table table-bordered table-striped table-hover">
                        ...
                        <tfoot>
                            <tr>                                 
                                <th colspan="4" style="text-align: right;">Total de Bines</th>
                                <th>${requestScope.Total}</th>
                            </tr>
                        </tfoot>
                        <tbody>

                            <c:forEach items="${BinInventory_Table}" var="row" varStatus="status">
                                <tr>                                 
