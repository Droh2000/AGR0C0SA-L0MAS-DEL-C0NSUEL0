...
<script>
    $(document).ready(function () {
        ...
        $('#formMaterial').submit(function (e) {
            ...
            $('#bomName').val(null).trigger('change');
            $("#quantity").val("");
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Salida de Insumos Compuestos
            <small>Consumo de insumos Compuestos</small>
        </h1>
        <ol class="breadcrumb">
    ...
    <section class="content">
        ...
        <div class="box box-success">
            <div class="box-header with-border">
                <h3 class="box-title">Salida de Insumos Compuestos</h3>
                    ...
                    <div class="row">
                        <div class="col-md-2">
                            <div class="form-group">
                                <label>Insumo Compuesto</label>
                                <select name="bomName" id="bomName" class="form-control" required>
                                    <option value=""></option>
                                    <c:forEach items="${Bom_HashMap}" var="item">
                                        <option value="${item.value}"  ${requestScope.SelectedBomName == item.value  ? 'selected' : ''}>${item.value}</option>
                                    </c:forEach>
                                </select>                              
                            </div>
                        </div>                                                
        ...
        <div class="box box-success">
            <div class="box-header with-border">
                <h3 class="box-title">Insumos Compuestos Seleccionados</h3>
                <div class="box-tools pull-right">
                    <button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
        ...
        <div class="hide">            
            <form name="formSaveData" id="formSaveData" action="consumeRawMaterialComposed.do" method="post">
