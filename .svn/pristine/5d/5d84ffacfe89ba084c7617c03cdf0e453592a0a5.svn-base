...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Reporte de Inventario de Insumos y Costo
            <small>Consulta de inventario de Insumos y costos</small>
        </h1>
        <ol class="breadcrumb">
    ...
    <section class="content">
        ...
        <!-- Search Meeting -->
        <form name="formsearch" role="form" action="rawMaterialInventoryCostReport.do" method="post">
                    ...
                    <table id="dtable" class="table table-bordered table-striped table-hover">
                        ...
                        <tfoot>
                            <tr>                                 
                                ...
                                <th><fmt:formatNumber value = "${requestScope.TotalInventory}" type = "currency"/></th>
                            </tr>
                        </tfoot>
                        <tbody>
                            ...
                            <c:forEach items="${RawMaterialInventory_Table}" var="row" varStatus="status">
                                <tr>                                 
                                    ...
                                    <td>${row.Qty}</td>
                                    <td>${row.UOM}</td>
                                    <td><fmt:formatNumber value = "${row.Cost}" type = "currency"/></td>
                                    <td><fmt:formatNumber value = "${row.Total}" type = "currency"/></td>
                                </tr>
                            </c:forEach>
                        </tbody>
                    </table> 
