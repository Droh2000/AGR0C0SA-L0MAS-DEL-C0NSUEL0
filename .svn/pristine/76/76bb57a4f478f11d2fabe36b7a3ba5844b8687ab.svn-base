...
public class PalletDefinitionManagementServlet extends SIDServlet {

    String managementTxn = "AgrocosaTransactions.PalletDefinitionManagementTransaction";
    ...
    protected void processRequest(HttpServletRequest request,
        ...
        try {
            ...
            if (txnNA != null) {
                txnNA.add("JspPage", "/palletDefinitionManagement.page");
                session.setAttribute("TxData", txnNA);
                response.sendRedirect("management.do");
            } else {
                rd = request.getRequestDispatcher("/palletDefinitionManagement.page");
