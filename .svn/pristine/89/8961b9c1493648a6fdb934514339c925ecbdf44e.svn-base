...
public class TransportCompanyManagementServlet extends SIDServlet {

    String managementTxn = "AgrocosaTransactions.TransportCompanyManagementTransaction";
    ...
    protected void processRequest(HttpServletRequest request,
        ...
        try {
            ...
            if (txnNA != null) {
                txnNA.add("JspPage", "/transportCompanyManagement.page");
                session.setAttribute("TxData", txnNA);
                response.sendRedirect("management.do");
            } else {
                rd = request.getRequestDispatcher("/transportCompanyManagement.page");
