...
public class SupplierManagementServlet extends SIDServlet {

    String managementTxn = "AgrocosaTransactions.SupplierManagementTransaction";
    ...
    protected void processRequest(HttpServletRequest request,
        ...
        try {
            ...
            if (txnNA != null) {
                txnNA.add("JspPage", "/supplierManagement.page");
                session.setAttribute("TxData", txnNA);
                response.sendRedirect("management.do");
            } else {
                rd = request.getRequestDispatcher("/supplierManagement.page");
