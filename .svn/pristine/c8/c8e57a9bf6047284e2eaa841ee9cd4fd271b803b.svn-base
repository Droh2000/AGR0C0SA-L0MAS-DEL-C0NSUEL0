...
public class CategoryManagementServlet extends SIDServlet {

    String managementTxn = "AgrocosaTransactions.CategoryManagementTransaction";
    ...
    protected void processRequest(HttpServletRequest request,
        ...
        try {
            ...
            if (txnNA != null) {
                txnNA.add("JspPage", "/categoryManagement.page");
                session.setAttribute("TxData", txnNA);
                response.sendRedirect("management.do");
            } else {
                rd = request.getRequestDispatcher("/categoryManagement.page");
