...
public class NewJournalTaskServlet extends SIDServlet {
    ...
    String laborTypeTxn = "AgrocosaTransactions.RetrieveLaborTypeTransaction";
    ...
    protected void processRequest(HttpServletRequest request,
        ...
        try {
            ...
            callTxnNA.add("taskTypeFilter", "Jornal");
            txnNA = executeTransaction(callTxnNA);
            ...
            if (redirectNA != null) {
                redirectNA.add("JspPage", "/newJournalTask.page");
                session.setAttribute("TxData", redirectNA);
                response.sendRedirect("management.do");
            } else {
                rd = request.getRequestDispatcher("/newJournalTask.page");
