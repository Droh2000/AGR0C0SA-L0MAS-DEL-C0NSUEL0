...
public class TaskFormulaReportServlet extends SIDServlet {

    String formulaTxn = "AgrocosaTransactions.FormulaMenuTransaction";
    String campTxn = "AgrocosaTransactions.CampMenuTransaction";
    String reportTxn = "AgrocosaTransactions.RetrieveTaskFormulaReportTransaction";
    ...
    protected void processRequest(HttpServletRequest request,
        ...
        try {
            ...
            if (redirectNA != null) {
                redirectNA.add("JspPage", "/taskFormulaReport.page");
                session.setAttribute("TxData", redirectNA);
                response.sendRedirect("management.do");
            } else {
                rd = request.getRequestDispatcher("/taskFormulaReport.page");
