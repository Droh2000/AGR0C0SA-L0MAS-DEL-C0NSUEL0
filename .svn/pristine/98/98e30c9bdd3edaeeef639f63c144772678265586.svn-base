...
public class IrrigationTypeManagementServlet extends SIDServlet {

    String managementTxn = "AgrocosaTransactions.IrrigationTypeManagementTransaction";
    ...
    protected void processRequest(HttpServletRequest request,
        ...
        try {
            ...
            if (txnNA != null) {
                txnNA.add("JspPage", "/irrigationTypeManagement.page");
                session.setAttribute("TxData", txnNA);
                response.sendRedirect("management.do");
            } else {
                rd = request.getRequestDispatcher("/irrigationTypeManagement.page");
