...
public class TractorManagementServlet extends SIDServlet {

    String managementTxn = "AgrocosaTransactions.TractorManagementTransaction";
    ...
    protected void processRequest(HttpServletRequest request,
        ...
        try {
            ...
            if (txnNA != null) {
                txnNA.add("JspPage", "/tractorManagement.page");
                session.setAttribute("TxData", txnNA);
                response.sendRedirect("management.do");
            } else {
                rd = request.getRequestDispatcher("/tractorManagement.page");
