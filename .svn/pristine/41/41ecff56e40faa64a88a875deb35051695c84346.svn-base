...
public class AjaxLineByProductServlet extends SIDServlet {

    String txn = "AgrocosaTransactions.AjaxLineByProductTransaction";
        ...
        try {
            ...
            if (nodeArray != null) {
                if (nodeArray.getSize() > 0
                        && nodeArray.exist("productinput")
                        && !nodeArray.find("productinput").isValueEmpty()) {
